...
var ERROR_CONF={
    ...
    SYSTEM_ERR:600,
    SYSTEM_ERR_MSG:"系统错误"
    ,WX_ERR_CODE:1000,WX_OK_CODE:200
};
...
var URL_AREA_LIST=BASE_URL+"district/v1/getchildren";var URL_DISTANCE=BASE_URL+"distance/v1/";
var Utils={
...
getWXLocation:function getWXLocation(c,b,a){
    wx.getLocation({
        type:"gcj02",success:c,fail:b,complete:a
    })
},
...
polyfillParam:function polyfillParam(a){
    ...
    a.complete=a.complete||function(){}},checkParamKeyEmpty:function checkParamKeyEmpty(c,b){
        if(!c[b]){
            var a=this.buildErrorConfig(ERROR_CONF.PARAM_ERR,ERROR_CONF.PARAM_ERR_MSG+b+"参数格式有误");
            c.fail(a);c.complete(a);
            return true
        }
        return false
    },
    ...
    buildErrorConfig:function buildErrorConfig(a,b){return{status:a,message:b}},buildWxRequestConfig:function buildWxRequestConfig(c,a){
        var b=this;a.header={
        ...
        a.complete=function(d){
            ...
            switch(e){
                ...
                break;
                default:c.complete(b.buildErrorConfig(ERROR_CONF.SYSTEM_ERR,ERROR_CONF.SYSTEM_ERR_MSG))
            }
        };
        return a
    },
            ...
            var QQMapWX=function(){
                ...
                _createClass(b,[{
                    key:"search",value:function f(i){
                        ...
                        var k={
                            keyword:i.keyword,orderby:i.orderby||"_distance",page_size:i.page_size||10,page_index:i.page_index||1,output:"json",key:l.key
                        };
                        if(i.address_format){
                ...
                },
                {
                    key:"getSuggestion",value:function h(i){
                        ...
                        var j={
                            keyword:i.keyword,region:i.region||"全国",region_fix:i.region_fix||0,policy:i.policy||0,output:"json",key:k.key
                        };
                        wx.request(Utils.buildWxRequestConfig(i,{
                            url:URL_SUGGESTION,data:j
                        }))
                    }
                },
                {
                    key:"reverseGeocoder",value:function a(i){
                        ...
                        var j={
                            ...
                            get_poi:i.get_poi||0,output:"json",
                            key:k.key
                        };
                        if(i.poi_options){
